...
\newcommand{\titel}{Een vergelijkende studie tussen Data Vault 2.0 en het dimensioneel model bij het modelleren van een data warehouse.}
...
\input{inleiding}
\input{standvanzaken}
\input{opzetonderzoek}
\input{vergelijkendonderzoek}
